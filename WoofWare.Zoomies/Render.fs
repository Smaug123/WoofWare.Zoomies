...
module Render =
    ...
    let inline private setAtRelativeOffset (arr: 'a[,]) (bounds: Rectangle) (relativeX: int) (relativeY: int) (v: 'a) =
        ...
        | _ ->
                ...
                | _ ->
                    ...
                    for y = 0 to bounds.Height - 1 do
                        for x = 0 to bounds.Width - 1 do
                            setAtRelativeOffset dirty bounds x y (ValueSome { Char = ' ' })
                    ...
                    while index < s.Length do
                        setAtRelativeOffset dirty bounds currX currY (ValueSome { Char = s.Chars index })
                        currX <- currX + 1
            ...
            | Vdom.Bordered child ->
                ...
                | _ ->
                    ...
                    setAtRelativeOffset dirty bounds 0 0 (ValueSome { Char = '┌' })
                    setAtRelativeOffset dirty bounds 0 (bounds.Height - 1) (ValueSome { Char = '└' })
                    setAtRelativeOffset dirty bounds (bounds.Width - 1) 0 (ValueSome { Char = '┐' })
                    setAtRelativeOffset dirty bounds (bounds.Width - 1) (bounds.Height - 1) (ValueSome { Char = '┘' })

                    for i = 1 to bounds.Width - 2 do
                        setAtRelativeOffset dirty bounds i 0 (ValueSome { Char = '─' })
                        setAtRelativeOffset dirty bounds i (bounds.Height - 1) (ValueSome { Char = '─' })

                    for i = 1 to bounds.Height - 2 do
                        setAtRelativeOffset dirty bounds 0 i (ValueSome { Char = '│' })
                        setAtRelativeOffset dirty bounds (bounds.Width - 1) i (ValueSome { Char = '│' })
