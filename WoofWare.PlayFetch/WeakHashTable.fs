...
type WeakHashTableEval<'ret> = abstract Eval<'a, 'b when 'a : equality and 'b : not struct> : WeakHashTable<'a, 'b> -> 'ret
type WeakHashTableCrate = abstract Apply<'ret> : WeakHashTableEval<'ret> -> 'ret
